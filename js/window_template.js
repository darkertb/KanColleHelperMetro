...
+"<div style='background-color:#7859B1; border-width:1px; border-style:solid;height:15'>"
...
+"</div>"
+"<iframe width='{2}px' height='{3}px' id='A{0}F' style='background-color:#000;border-style:solid;border-width:1px;' src='{7}'>"
+"</iframe>"
