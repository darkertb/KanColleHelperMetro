var platformList = [
			...
			{'key': 'AFTVN', 'name': 'AfreecaTVn', 'sUrl': 'http://afreeca.tv/{ID}', 'vUrl': 'https://gaftvstatic.afreeca.tv/swf/LivePlayer.swf?id={ID}&s=embed', 'cUrl': 'http://www.afreeca.tv/channel/live_chat.php?id={ID}'},
